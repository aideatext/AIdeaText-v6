                    ...
                    with st.spinner("Analyzing..."):
                        try:
                            ...
                            if 'graph_id' not in st.session_state:
                                st.session_state.graph_id = float_graph(graph_content, width="540px", height="540px", position="center-right")
                            else:
                            ...
                            # Depuración: Mostrar el grafo directamente en la interfaz
