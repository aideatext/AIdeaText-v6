...
#from .semantic_float import semantic_float_init, float_graph, toggle_float_visibility, update_float_content
                ...
                if file_contents:
                    with st.spinner("Analyzing..."):
                        try:
                            ...
                            # Depuración: Verificar si el grafo se está creando
                            logger.debug(f"Graph ID: {st.session_state.graph_id}")
                            logger.debug(f"Graph visible: {st.session_state.graph_visible}")

                            # Mostrar el grafo directamente en la interfaz para verificación
